...
const translations = {
    vi: {
        ...
        // About Us Page
        'about.hero_title': 'Về Chúng Tôi',
        'about.hero_subtitle': 'Đồng hành cùng bạn trên mọi hành trình đẳng cấp',
        'about.story_subtitle': 'Câu Chuyện Của Chúng Tôi',
        'about.story_title': 'Hành Trình Kiến Tạo <span class="gradient-text">Đẳng Cấp</span>',
        'about.story_p1': 'Tại Bookcarvip, chúng tôi tự hào mang đến dịch vụ tài xế chuyên nghiệp cao cấp từ đầu đến cuối. Công ty được thành lập vào năm 2004 dưới thương hiệu Carvip, và kể từ đó chúng tôi đã không ngừng mở rộng dịch vụ của mình từ thành phố Hồ Chí Minh đến các điểm đến trên khắp Việt Nam.',
        'about.story_p2': 'Đội ngũ tài xế chuyên nghiệp tận tâm của chúng tôi thấu hiểu tầm quan trọng của mỗi hành trình, dù đó là chuyến đón tiễn sân bay ngắn gọn hay một chuyến đi đường dài. Với Bookcarvip, bạn luôn làm chủ lịch trình, đến nơi đúng giờ và tận hưởng từng khoảnh khắc di chuyển trong sự thoải mái và sành điệu.',
        'about.story_p3': 'Cho dù bạn đi công tác hay nghỉ dưỡng, bạn hoàn toàn có thể tin tưởng đội ngũ giàu kinh nghiệm của chúng tôi để có được trải nghiệm di chuyển sang trọng và liền mạch. Một khi bạn đã trải nghiệm sự thoải mái, uy tín và chuyên nghiệp của Bookcarvip, bạn sẽ không bao giờ muốn quay lại các dịch vụ vận tải thông thường.',
        'about.stats_years': '20+',
        'about.stats_years_label': 'Năm Kinh Nghiệm',
        'about.stats_trips': '50K+',
        'about.stats_trips_label': 'Chuyến Đi Thành Công',
        'about.stats_clients': '10K+',
        'about.stats_clients_label': 'Khách Hàng Hài Lòng',
        'about.why_subtitle': 'Giá Trị Cốt Lõi',
        'about.why_title': 'Tại Sao Chọn <span class="gradient-text">Chúng Tôi</span>',
        'about.why_desc': 'Chúng tôi không chỉ cung cấp dịch vụ cho thuê xe, chúng tôi mang đến trải nghiệm xứng tầm đẳng cấp.',
        'about.val_fleet_title': 'Đội Xe Cao Cấp Tân Tiến',
        'about.val_fleet_desc': 'Sở hữu bộ sưu tập các dòng xe sang trọng đời mới nhất, được bảo dưỡng định kỳ vô điều kiện.',
        'about.val_driver_title': 'Tài Xế Chuyên Nghiệp',
        'about.val_driver_desc': 'Đội ngũ lái xe được đào tạo bài bản, chuẩn mực giao tiếp và đặc biệt am hiểu mọi cung đường.',
        'about.val_support_title': 'Hỗ Trợ 24/7 Tận Tâm',
        'about.val_support_desc': 'Đội ngũ chăm sóc khách hàng luôn sẵn sàng hỗ trợ bạn bất cứ lúc nào, mọi nơi, mọi lúc.',
        'about.val_price_title': 'Giá Cả Cạnh Tranh Rõ Ràng',
        'about.val_price_desc': 'Cam kết mang đến dịch vụ xứng đáng với từng khoản đầu tư của bạn với giá cả minh bạch.',
        'about.cta_title': 'Sẵn Sàng Trải Nghiệm Đẳng Cấp?',
        'about.cta_desc': 'Hãy để chúng tôi đồng hành cùng bạn trên mọi hành trình. Đặt xe ngay hôm nay!',
        'about.cta_book': 'Đặt Xe Ngay',
        'about.cta_contact': 'Liên Hệ Ngay',
        'about.cta_learn_more': 'Tìm Hiểu Về Chúng Tôi',
        ...
        'booking.step_driver_info': 'Thông Tin Khách Hàng',
        ...
        'booking.driver_name': 'Tên khách hàng',
    ...
    en: {
        ...
        'about.hero_subtitle': 'Accompanying you on every premium journey',
        'about.story_subtitle': 'Our Story',
        'about.story_title': 'A Journey to Create <span class="gradient-text">Excellence</span>',
        'about.story_p1': 'At Bookcarvip, we take pride in delivering a premium chauffeur service from start to finish. The company was established in 2004 under the Carvip brand, and since then we have continuously expanded our services beyond Ho Chi Minh City to destinations across Vietnam.',
        'about.story_p2': 'Our dedicated team of professional chauffeurs understands the importance of every journey, whether it is a short airport transfer or a long-distance trip. With Bookcarvip, you stay in control of your schedule, arrive on time, and enjoy every moment of your journey in comfort and style.',
        'about.story_p3': 'Whether you are traveling for business or leisure, you can rely on our experienced team to provide a seamless and luxurious transportation experience. Once you experience the comfort, reliability, and professionalism of Bookcarvip, you will never want to return to ordinary transportation services.',
        'about.stats_years': '20+',
        'about.stats_years_label': 'Years Experience',
        'about.stats_trips': '50K+',
        'about.stats_trips_label': 'Successful Trips',
        'about.stats_clients': '10K+',
        'about.stats_clients_label': 'Happy Clients',
        'about.why_subtitle': 'Core Values',
        'about.why_title': 'Why Choose <span class="gradient-text">Us</span>',
        'about.why_desc': 'At Bookcarvip, we don’t just drive — we create exceptional travel experiences.<br><br>Whether you are traveling for business or leisure, we are ready to provide first-class chauffeur services tailored to your needs. From airport transfers to hourly chauffeur services, our fleet of luxury vehicles is operated by highly trained and multilingual chauffeurs, ensuring a safe, smooth, and comfortable journey to your destination.<br><br>With our commitment to punctuality, professionalism, and premium service, Bookcarvip is the trusted choice for travelers who value reliability and luxury transportation in Vietnam.',
        'about.val_fleet_title': 'Advanced Premium Fleet',
        'about.val_fleet_desc': 'Owning a collection of the newest luxury car lines, unconditionally maintained periodically.',
        'about.val_driver_title': 'Professional Drivers',
        'about.val_driver_desc': 'Well-trained drivers with standard communication and deep understanding of all routes.',
        'about.val_support_title': 'Dedicated 24/7 Support',
        'about.val_support_desc': 'Customer care team is always ready to support you anytime, anywhere, anytime.',
        'about.val_price_title': 'Clear Competitive Pricing',
        'about.val_price_desc': 'Committed to bringing services worthy of your investment with transparent pricing.',
        'about.cta_title': 'Ready to Experience Excellence?',
        'about.cta_desc': 'Let us accompany you on every journey. Book a car today!',
        'about.cta_book': 'Book Now',
        'about.cta_contact': 'Contact Us',
        'about.cta_learn_more': 'Learn About Us',
        ...
        'booking.step_driver_info': 'Customer Info',
        ...
        'booking.driver_name': 'Customer Name',
